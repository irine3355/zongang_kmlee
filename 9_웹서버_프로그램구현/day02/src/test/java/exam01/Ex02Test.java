...
public class Ex02Test {
    ...
    void init() {
        ...
        //스텁(stub ) 추가
        given(request.getParameter("email")).willReturn(faker.internet().emailAddress().emailAddress());
        given(request.getParameter("password")).willReturn(faker.regexify().emailAddress().emailAddress());
    }
}
